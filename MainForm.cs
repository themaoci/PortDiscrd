...
namespace PortDiscrd {
	...
	internal partial class MainForm : Form {
		...
		private void LoadURL(string url) {
			...
			if (!urlLower.StartsWith("https://discord.com")) return;
			if (urlLower.StartsWith("https://discord.com/api")) return;
			if (urlLower.StartsWith("https://images-ext")) return;
			if (urlLower.Contains("maxresdefault.jpg")) return;
			// UI
			SetTabTitle(CurBrowser, "Loading (" + url + ")");
